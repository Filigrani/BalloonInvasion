...
using BalloonInvasion.Networking;
using static BalloonInvasion.Network;
        ...
        public static void Init()
        {
            if (Network.IsHost())
            {
                packetHandlers = new Dictionary<int, PacketHandlerMethod>()
                {
                    ...
                    { (int)PacketsIDs.PLAYERDATA, ServerHandler.PLAYERDATA },
                };
            }
            if (Network.IsClient())
            {
                packetHandlers = new Dictionary<int, PacketHandlerMethod>()
                {
                    ...
                    { (int)PacketsIDs.JOIN, ClientHandler.JOIN },
                };
            }
        }
