...
namespace BalloonInvasion
{
    internal class Renderer : Component
    {
        ...
        public void SetSprite(Color[] Color, int W, int H)
        {
            if(Sprite == null)
            {
                Sprite = new Texture2D(GameManager.Game.GraphicsDevice, W, H);
        ...
        public void Render()
        {
            ...
            Rectangle ScreenRect = new Rectangle(0, 0, GameManager.Game.WindowWidth, GameManager.Game.WindowHeight);
